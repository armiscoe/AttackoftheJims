...
function gameOver () {
    ...
    setTimeout(() => {
        let jimWin = document.createElement('img')
        jimWin.src = 'images/chomper.gif'
        jimWin.classList.add('jimWin')
       ...
       restartShow.innerText = 'F5 to TRY AGAIN'
       restartShow.style.left = '80px'
